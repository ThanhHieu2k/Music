    ...
    songs: [
        {
            ...
            path: './assets/audio/ThangNam.mp3',
            img: './assets/img/img-ThangNam.jpg'
        },
        {
            name: 'Treasure',
            singer: 'Rhymastic',
            path: './assets/audio/Treasure.mp3',
            img: './assets/img/img-Treasure.jpg'
        },
        {
            name: 'Trời Hôm nay Nhiều Mây Cực',
            singer: 'Đen Vâu',
            path: './assets/audio/TroiHomNayNhieumayCuc.mp3',
            img: './assets/img/img-TroiHomNayNhieuMayCuc.jpg'
        },
        {
            name: 'Sorry',
            singer: 'Justin Bieber',
            path: './assets/audio/Sorry-JustinBieber.mp3',
            img: './assets/img/img-Sorry.jpg'
        },
        {
            name: 'Mama',
            singer: 'Jonas Blue ft. William Singe',
            path: './assets/audio/Mama-JonasBlueWilliam.mp3',
            img: './assets/img/img-Mama.jpg'
        },
        {
            name: 'Dusk Till Dawn',
            singer: 'ZAYN & Sia',
            path: './assets/audio/DuskTillDawn.mp3',
            img: './assets/img/img-DuskTillDawn.jpg'
        },
        {
            name: 'Nevada',
            singer: 'Vicetone',
            path: './assets/audio/Nevada.mp3',
            img: './assets/img/img-Nevada.jpg'
        },
        {
            name: 'Closer',
            singer: 'The Chainsmokers ',
            path: './assets/audio/Closer.mp3',
            img: './assets/img/img-Closer.jpg'
        },
        {
            name: 'All Around The World',
            singer: 'LR3HAB x A Touch Of Class ',
            path: './assets/audio/AllAroundTheWorld.mp3',
            img: './assets/img/img-AllAroundTheWorld.jpg'
        },
        {
            name: 'See You Again',
            singer: 'Wiz Khalifa ft. Charlie Puth',
            path: './assets/audio/SeeYouAgain.mp3',
            img: './assets/img/img-SeeYouAgain.jpg'
        },
        {
            name: 'In The End',
            singer: 'Linkin Park ',
            path: './assets/audio/InTheEnd.mp3',
            img: './assets/img/img-InTheEnd.jfif'
        }
    ],
